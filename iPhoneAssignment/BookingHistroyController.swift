...
class BookingHistroyController: UITableViewController {
    ...
    override func tableView(tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        return self.bookingHistroy.count
    }
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        cell.textLabel!.text = booking.id
    ...
    */
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        let receptController = segue.destinationViewController as! ReceiptController
        let indexPath = self.tableView.indexPathForSelectedRow!
        let booking = self.bookingHistroy[indexPath.row]
        receptController.booking = booking
